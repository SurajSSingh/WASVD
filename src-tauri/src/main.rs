...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Type, derive_more::From)]
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Type, Default)]
pub struct InputOutput {
    index: Option<String>,
    input: Vec<(Option<String>, SerializableWatType)>,
...
impl TryFrom<&Instruction<'_>> for SerializedInstruction {
    ...
    fn try_from(value: &Instruction<'_>) -> Result<Self, Self::Error> {
        ...
        Ok(match value {
            ...
            Instruction::MemorySize(m) => SI::memory_instruction(index_to_string(&m.mem), false),
            ...
            Instruction::I32RemU => SI::arithmetic_instruction(Type::I32, AOp::RemainderUnsigned),
            ...
            Instruction::I64RemU => SI::arithmetic_instruction(Type::I64, AOp::RemainderUnsigned),
            ...
            Instruction::I32GtS => SI::comparison_instruction(Type::I32, COp::GreaterThenSigned),
            Instruction::I32GtU => SI::comparison_instruction(Type::I32, COp::GreaterThenUnsigned),
            Instruction::I32LeS => {
            ...
            Instruction::I64GtS => SI::comparison_instruction(Type::I64, COp::GreaterThenSigned),
            Instruction::I64GtU => SI::comparison_instruction(Type::I64, COp::GreaterThenUnsigned),
            Instruction::I64LeS => {
            ...
            Instruction::I32TruncF32U => SI::conversion_instruction(Type::F32, Type::I32, false),
            Instruction::I32TruncF64S => SI::conversion_instruction(Type::F64, Type::I32, true),
            Instruction::I32TruncF64U => SI::conversion_instruction(Type::F64, Type::I32, false),
            Instruction::I64ExtendI32S => SI::conversion_instruction(Type::I32, Type::I64, true),
            Instruction::I64ExtendI32U => SI::conversion_instruction(Type::I32, Type::I64, false),
            Instruction::I64TruncF32S => SI::conversion_instruction(Type::F32, Type::I64, true),
            Instruction::I64TruncF32U => SI::conversion_instruction(Type::F32, Type::I64, false),
            Instruction::I64TruncF64S => SI::conversion_instruction(Type::F64, Type::I64, true),
            Instruction::I64TruncF64U => SI::conversion_instruction(Type::F64, Type::I64, false),
            Instruction::F32ConvertI32S => SI::conversion_instruction(Type::I32, Type::F32, true),
            Instruction::F32ConvertI32U => SI::conversion_instruction(Type::I32, Type::F32, false),
            Instruction::F32ConvertI64S => SI::conversion_instruction(Type::I64, Type::F32, true),
            Instruction::F32ConvertI64U => SI::conversion_instruction(Type::I64, Type::F32, false),
            Instruction::F32DemoteF64 => SI::conversion_instruction(Type::F64, Type::F32, true),
            Instruction::F64ConvertI32S => SI::conversion_instruction(Type::I32, Type::F64, true),
            Instruction::F64ConvertI32U => SI::conversion_instruction(Type::I32, Type::F64, false),
            Instruction::F64ConvertI64S => SI::conversion_instruction(Type::I64, Type::F64, true),
            Instruction::F64ConvertI64U => SI::conversion_instruction(Type::I64, Type::F64, true),
            Instruction::F64PromoteF32 => SI::conversion_instruction(Type::F32, Type::F64, false),
...
pub struct WastFunc {
    ...
    body: Vec<SerializedInstruction>,
...
fn create_buffer(text: &str) -> WastResult<ParseBuffer> {
